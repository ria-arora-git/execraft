...
const ThemeContext = createContext<ThemeContextType & { setTheme: (themeName: ThemeName) => void } | undefined>(undefined)
...
const ThemeProvider: React.FC<ThemeProviderProps> = ({
    ...
    (themeName: ThemeName, themeMode: ThemeMode) => {
      try {
        localStorage.setItem(
          storageKey,
          JSON.stringify({ themeName, mode: themeMode })
        )
      } catch (error) {
  ...
  const contextValue: ThemeContextType & { setTheme: (themeName: ThemeName) => void } = {
    theme: currentTheme,
    mode,
...
// ============================================================================
// THEME UTILITIES (unchanged; keep exports so imports don't break)
// ============================================================================
...
// Default export for Next.js/React auto-inject
